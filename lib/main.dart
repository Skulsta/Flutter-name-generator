...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Color mainColor = const Color.fromRGBO(102, 67, 47, 1);
    return ValueListenableBuilder<ThemeMode>(
        ...
        builder: (_, ThemeMode currentMode, __) {
          return MaterialApp(
            ...
            title: 'Navn',
            theme: ThemeData(useMaterial3: true, colorSchemeSeed: mainColor, brightness: Brightness.light),
            darkTheme: ThemeData(useMaterial3: true, colorSchemeSeed: mainColor, brightness: Brightness.dark),
